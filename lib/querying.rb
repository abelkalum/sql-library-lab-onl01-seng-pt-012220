...
def select_series_title_with_most_human_characters
   "SELECT series.title, character.species FROM series JOIN characters ON series.author_id = characters.author_id GROUP BY series.title ORDER BY COUNT(species) DESC LIMIT 1;"
end
