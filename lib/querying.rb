...
def select_series_title_with_most_human_characters
   "SELECT series.title, character.species FROM series JOIN characters ON series.author_id = characters.author_id JOIN subgenres ON series.subgenre_id = subgenres.id;"
end
